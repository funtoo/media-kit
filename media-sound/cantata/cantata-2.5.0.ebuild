...
SRC_URI="https://github.com/CDrummond/cantata/tarball/46a6c7b5ec46184288a3efde8245921f36777146 -> cantata-2.5.0-46a6c7b.tar.gz"
...
post_src_unpack() {
	if [ ! -d "${S}" ]; then
		mv "${WORKDIR}"/CDrummond-cantata* "${S}" || die
	fi
}
