...
SRC_URI="https://api.github.com/repos/AOMediaCodec/libavif/tarball/refs/tags/v0.11.0-rc1 -> libavif-0.11.0-rc1.tar.gz"
...
fix_src_dirs() {
	pushd "${WORKDIR}"
	mv AOMediaCodec-libavif-* libavif-0.11.0-rc1
	popd
}
