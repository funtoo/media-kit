...
SRC_URI="
	https://api.github.com/repos/obsproject/obs-studio/tarball/29.0.0 -> obs-studio-29.0.0.tar.gz
	...
	https://api.github.com/repos/obsproject/obs-websocket/tarball/refs/tags/5.1.0 -> obs-websocket-5.1.0.tar.gz
...
post_src_unpack() {
	...
	elog "Copying obs-websocket-5.1.0 sources to OBS plugins directory."
