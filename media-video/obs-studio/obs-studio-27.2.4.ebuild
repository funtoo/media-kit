...
SRC_URI="
	...
	https://api.github.com/repos/obsproject/obs-websocket/tarball/refs/tags/5.3.2 -> obs-websocket-5.3.2.tar.gz
...
post_src_unpack() {
	...
	elog "Copying obs-websocket-5.3.2 sources to OBS plugins directory."
