...
SRC_URI="
	https://api.github.com/repos/obsproject/obs-studio/tarball/29.1.3 -> obs-studio-29.1.3.tar.gz
	...
	https://api.github.com/repos/obsproject/obs-websocket/tarball/refs/tags/5.2.3 -> obs-websocket-5.2.3.tar.gz
...
post_src_unpack() {
	...
	elog "Copying obs-websocket-5.2.3 sources to OBS plugins directory."
	...
	elog "Copying obs-amd-encoder-2.8.0 sources to OBS plugins directory."
